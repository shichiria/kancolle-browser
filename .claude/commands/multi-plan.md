---
description: Create implementation plan using multiple agents.
---
---
description: Multi-model collaborative planning with context retrieval and dual-model analysis
---
