...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            window_toggle::show_improvement_window,
            window_toggle::hide_improvement_window,
            window_toggle::toggle_improvement_window,
            ...
            game_window::screenshot::take_game_screenshot,
            game_window::screenshot::get_screenshot_settings,
            game_window::screenshot::get_default_screenshot_settings,
            game_window::screenshot::set_screenshot_settings,
            game_window::screenshot::choose_screenshot_directory,
